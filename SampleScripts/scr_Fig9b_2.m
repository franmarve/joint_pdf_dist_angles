...
% *************************************************************************
% DESCRIPTION:
% This script generates some graphs included in Fig. 9 (b) of [1]
% *************************************************************************
% REFERENCE:
...
% *************************************************************************
% *) Result folder
p.resultFolder = 'scr_Fig9b_2_Lx_Ly_10_10_u_m4_m4_xi0topid2';
...
p.xVct = num2cell(linspace(0, pi/2, p.nVal));
